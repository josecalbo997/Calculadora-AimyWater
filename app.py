...
# --- FUNCIÓN CALCULAR CORREGIDA (12 ARGUMENTOS) ---
# Hemos eliminado 'buffer_on' de la definición porque ahora siempre usamos deposito bruta
...
if st.session_state.get('run'):
    # LLAMADA CORREGIDA V63 (12 argumentos)
